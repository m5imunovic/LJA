...
The instructions are in `https://github.com/m5imunovic/gnndbg/apptainer/README.md`


## `LJA` - `gnndbg` interface
...
git clone https://github.com/AntonBankevich/LJA/tree/feature/gnndebugger
```
...
```
Create a directory "/data/config/" and place `test_config.yaml` file containing inference config inside
